...
// Severity model v2
// ─────────────────
//   low      — document quality / legibility issue (not a fraud indicator)
//   medium   — suspicious context requiring human review
//   high     — strong fraud indicator (duplicate, structural forgery)
//   critical — reserved for definitive fraud with high confidence
//
// LOW signals alone are capped at MEDIUM risk by the scoring model.
// See lib/fraud/risk-score.ts for the full scoring rationale.
